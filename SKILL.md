...
- Timestamp: Current date/time in format `yyyy-mm-dd-hh-mm-ss` (24-hour format, local system time)
...
- Some prompts may be rejected if they violate Gemini's content policies
- If generation fails with a policy error, suggest the user rephrase their prompt
